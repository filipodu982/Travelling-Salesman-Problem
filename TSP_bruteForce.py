...
points = 20                                                                      #how many cities do we want?
...
while not done:
    ...
    random.shuffle(pop)                                                         #shuffling the order of cities
    passed += 1.0
    print round((passed/howMany)*100,2)                                                  #percent of finished permutations. however not the most accurate way, because shuffle function repeats some permutations which are not checked anywhere
